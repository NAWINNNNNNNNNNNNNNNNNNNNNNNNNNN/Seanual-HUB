...
CreateThread(function()
    ...
    function FM.FreeCam:Spawner(where, heading, type)
        ...
        FM.Painter:DrawText("~w~[~y~Wantteen Menu~w~] " .. (name or "?"), 4, false, FM:ScrW() - 360 - 21 - offX, 21, 0.35, 255, 255, 255, 255)
        local sY = 30
        local max_opts = 30
    ...
    function FM:DrawNotifications()
        ...
        self.Painter:DrawText("~w~[~y~Wantteen Menu~w~] Notifications", 4, false, n_x, n_y, 0.35, 255, 255, 255, dict.math.ceil(notif_alpha + 55))
